...
export default function AppointmentForm({
  ...
  return (
    <>
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="flex flex-col flex-1 min-h-0 w-full">
        <div className="p-5 sm:p-6 pb-4 border-b shrink-0 bg-white z-10 sticky top-0">
          <DialogHeader>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-5 flex flex-col min-h-0">
