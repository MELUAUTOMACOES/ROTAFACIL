                        ...
                        <CardTitle className="flex items-center gap-2 text-lg">
                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <span className="cursor-help border-b border-dashed border-gray-400">Gastos com Manutenção</span>
                                </TooltipTrigger>
                                <TooltipContent className="max-w-xs">
                                    <p>Soma dos custos de manutenções registradas no mês e ano atual. Pode filtrar por veículo.</p>
                                </TooltipContent>
                            </Tooltip>
                        </CardTitle>
                        <Select
