...
export function DashboardFilters({
    ...
    return (
        <div className="flex flex-wrap items-center gap-3 p-4 md:p-5 bg-muted/20 dark:bg-zinc-900/50 rounded-xl border border-border/60 shadow-sm dark:border-zinc-800">
